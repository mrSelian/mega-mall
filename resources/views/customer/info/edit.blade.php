<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        ...
        <div class="antialiased text-gray-900">
            ...
            <form action="{{route('update_customer_info')}}" method="POST" class="form mt-4">
                @method('PATCH')
                <div class="mx-4 card bg-white max-w-md p-10 md:rounded-lg my-12 mx-auto">
                    <label for="customer_info" class=" control-label font-bold text-center"><h1>Изменить контакты</h1></label>
